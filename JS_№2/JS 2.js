...
if (sum < 199){
    ...
    alert(`Сумма покупки: ${sum - (sum * 0.03)} р  Скидка: ${sum * 0.03}р`); 
} else if(sum < 499){
    alert(`Сумма покупки: ${sum - (sum * 0.05)} р  Скидка: ${sum * 0.05}р`);
} else {
     alert(`Сумма покупки: ${sum - (sum * 0.07)} р Скидка: ${sum * 0.07}р`);
}
